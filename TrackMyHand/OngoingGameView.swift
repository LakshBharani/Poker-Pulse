...
#Preview {
    OngoingGameView(game: Game(isActive: true, buyIn: 10, isGameEnded: false, id: "7B97E339-3EEF-4431-B6A7-85681B64D002", timeElapsed: [0, 0, 0], gameCode: "7B9002", totalPot: 40.0, cashOut: 0, date: Date(), players: [TrackMyHand.Player(id: "LA", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "AT", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "SAI", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "US", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "AR", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "SAH", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "AN", buyIn: 5.0, cashOut: 0.0, profit: -5.0), TrackMyHand.Player(id: "LAY", buyIn: 5.0, cashOut: 0.0, profit: -5.0)], events: []),
